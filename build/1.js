...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__charts_page__ = __webpack_require__(556);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(519);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_common_http__ = __webpack_require__(518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_rest_rest_service__ = __webpack_require__(525);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_angular2_highcharts__ = __webpack_require__(557);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Highcharts__ = __webpack_require__(564);
...
var ChartsPageModule = /** @class */ (function () {
    ...
    ChartsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__charts_page__["a" /* ChartsPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_6_angular2_highcharts__["ChartModule"].forRoot(__WEBPACK_IMPORTED_MODULE_7_Highcharts__),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__charts_page__["a" /* ChartsPage */])
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_5__providers_rest_rest_service__["a" /* RestService */]
            ]
        })
    ], ChartsPageModule);
...
//# sourceMappingURL=charts.page.module.js.map
...
var ChartPointComponent_1 = __webpack_require__(539);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth_service__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rest_rest_service__ = __webpack_require__(525);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChartsPage = /** @class */ (function () {
    function ChartsPage(authService, navCtrl, restService) {
        this.authService = authService;
        this.navCtrl = navCtrl;
    ...
    ChartsPage.prototype.ionViewCanEnter = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCandidates()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.authService.authenticated];
                }
            });
        });
    };
    ChartsPage.prototype.getCandidates = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.restService.getAllCandidates()
                .then(function (candidates) { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                var _a, _b, _i, i;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            i = _a[_i];
                            if (!candidates.hasOwnProperty(i)) return [3 /*break*/, 3];
                            this.labels.push(candidates[i].name);
                            return [4 /*yield*/, this.getVotes(candidates[i]._id)
                                    .then(function (data) {
    ...
    ChartsPage.prototype.getVotes = function (uuid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var count = 0;
                        _this.restService.getVotes()
                            .then(function (votes) {
    ...
    ChartsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-charts',template:/*ion-inline-start:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\charts\charts.page.html"*/'<ion-header>\n\n  <custom-header [title]="\'Charts Page\'"></custom-header>\n\n</ion-header>\n\n\n\n<ion-content text-center padding>\n\n  <chart [options] = "chartOptions" style="display: block" type = "chart"> </chart>\n\n</ion-content>'/*ion-inline-end:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\charts\charts.page.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_auth_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_rest_rest_service__["a" /* RestService */]])
    ], ChartsPage);
    return ChartsPage;
}());
...
var core_1 = __webpack_require__(0);
var ChartComponent_1 = __webpack_require__(559);
exports.ChartComponent = ChartComponent_1.ChartComponent;
var ChartSeriesComponent_1 = __webpack_require__(538);
...
var ChartXAxisComponent_1 = __webpack_require__(540);
exports.ChartXAxisComponent = ChartXAxisComponent_1.ChartXAxisComponent;
var ChartYAxisComponent_1 = __webpack_require__(541);
exports.ChartYAxisComponent = ChartYAxisComponent_1.ChartYAxisComponent;
var HighchartsService_1 = __webpack_require__(542);
...
var ChartYAxisComponent_1 = __webpack_require__(541);
var HighchartsService_1 = __webpack_require__(542);
var initChart_1 = __webpack_require__(560);
var createBaseOpts_1 = __webpack_require__(562);
...
var deepAssign_1 = __webpack_require__(561);
...
var ChartEvent_1 = __webpack_require__(563);
var chartEvents = [
    'addSeries',
    'afterPrint',
    'beforePrint',
