...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScannedCandidatePageModule", function() { return ScannedCandidatePageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest_service__ = __webpack_require__(525);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__scanned_candidate_page__ = __webpack_require__(568);
...
var ScannedCandidatePageModule = /** @class */ (function () {
    function ScannedCandidatePageModule() {
    }
    ScannedCandidatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_5__scanned_candidate_page__["a" /* ScannedCandidatePage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__scanned_candidate_page__["a" /* ScannedCandidatePage */])
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest_service__["a" /* RestService */]
            ]
        })
    ], ScannedCandidatePageModule);
    return ScannedCandidatePageModule;
}());

//# sourceMappingURL=scanned-candidate.page.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ScannedCandidatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_rest_rest_service__ = __webpack_require__(525);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user_service__ = __webpack_require__(157);
...
var ScannedCandidatePage = /** @class */ (function () {
    function ScannedCandidatePage(alertCtrl, navCtrl, navParams, platform, restService, userService) {
        var _this = this;
        this.alertCtrl = alertCtrl;
        this.navCtrl = navCtrl;
    ...
    ScannedCandidatePage.prototype.ionViewDidLoad = function () {
        this.candidate = this.navParams.data;
        this.getCurrentUser();
    };
    ScannedCandidatePage.prototype.getCurrentUser = function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.userService.currentUser
                            .snapshotChanges()
                            .pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["map"])(function (action) { return (__assign({ $key: action.key }, action.payload.val())); })).subscribe(function (user) {
    ...
    ScannedCandidatePage.prototype.onCancel = function () {
        this.navCtrl.pop();
    };
    ScannedCandidatePage.prototype.onVote = function () {
        var _this = this;
        var vote = {
        ...
        this.restService.addVote(vote)
            ...
            _this.userService.edit({
                name: _this.currentUser.name,
                username: _this.currentUser.username,
                photo: _this.currentUser.photo || '',
                voted: true
            });
            _this.showAlert("Success", "Your vote has been registered.");
            _this.navCtrl.pop();
        }).catch(function (err) {
            console.log('Error: ', err);
        });
    };
    ScannedCandidatePage.prototype.showAlert = function (title, message) {
        this.alertCtrl.create({
            title: title,
            subTitle: message,
            buttons: ['OK']
    ...
    ScannedCandidatePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-scanned-candidate',template:/*ion-inline-start:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\scanned-candidate\scanned-candidate.page.html"*/'<ion-content>\n\n  <generic-profile [user]="candidate"></generic-profile>\n\n  <button ion-button outline block (click)="onVote()">Vote</button>\n\n  <button ion-button outline block (click)="onCancel()">Cancel</button>\n\n</ion-content>'/*ion-inline-end:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\scanned-candidate\scanned-candidate.page.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_2__providers_rest_rest_service__["a" /* RestService */],
            __WEBPACK_IMPORTED_MODULE_3__providers_user_user_service__["a" /* UserService */]])
    ], ScannedCandidatePage);
    return ScannedCandidatePage;
}());

//# sourceMappingURL=scanned-candidate.page.js.map
