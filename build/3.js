...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__admin_page__ = __webpack_require__(553);
...
var AdminPageModule = /** @class */ (function () {
    ...
    AdminPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__admin_page__["a" /* AdminPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__admin_page__["a" /* AdminPage */])
            ],
            providers: [
...
var AdminPage = /** @class */ (function () {
    function AdminPage(authService, navCtrl, platform, qrcode, userService) {
        var _this = this;
        this.authService = authService;
        this.navCtrl = navCtrl;
        this.platform = platform;
    ...
    AdminPage.prototype.onGetBarcode = function () {
        this.qrcode.scanAndFindUser(false);
    };
    AdminPage.prototype.onSelectUser = function (user) {
        console.log(user);
    };
    AdminPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-admin',template:/*ion-inline-start:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\admin\admin.page.html"*/'<ion-header>\n\n  <custom-header [title]="\'Admin Page\'"></custom-header>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <button ion-button block (click)="onGetBarcode()">Elector Verify</button>\n\n  <br>\n\n  <ion-list no-lines>\n\n    <button ion-item *ngFor="let user of users | async" (click)="onSelectUser(user)">\n\n      {{ user.name }}\n\n    </button>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\admin\admin.page.html"*/,
        }),
