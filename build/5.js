...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__candidates_page__ = __webpack_require__(555);
    ...
    CandidatesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__candidates_page__["a" /* CandidatesPage */]),
...
var CandidatesPage = /** @class */ (function () {
    function CandidatesPage(authService, navCtrl, restService) {
        this.authService = authService;
        this.navCtrl = navCtrl;
    ...
    CandidatesPage.prototype.ionViewCanEnter = function () {
    ...
    CandidatesPage.prototype.initializeCandidates = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.restService.getAllCandidates()
                            .then(function (data) {
    ...
    CandidatesPage.prototype.getItems = function (ev) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.initializeCandidates()];
                    case 1:
                        _a.sent();
                        val = ev.target.value;
                        if (val && val.trim() != '') {
    ...
    CandidatesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-candidates',template:/*ion-inline-start:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\candidates\candidates.page.html"*/'<ion-header>\n\n  <custom-header [title]="\'Candidates Page\'"></custom-header>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <ion-card>\n\n        <ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n\n        <ion-list>\n\n          <button ion-item *ngFor="let candidate of candidates; let i = index" (click)="viewProfile(i)">  \n\n            <ion-avatar item-start>\n\n                <img src="./assets/imgs/author.jpg" />  \n\n            </ion-avatar>\n\n            <h2>{{ candidate.name }}</h2>\n\n            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facere numquam minima eos tempora ipsam nobis praesentium similique dolores inventore harum exercitationem eaque consequatur repellat quibusdam aspernatur sint asperiores, voluptatibus corporis.</p>\n\n            <ion-note item-end>#{{ candidate.number }}</ion-note>\n\n          </button>      \n\n        </ion-list>\n\n      </ion-card>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\EliasdeCarvalhoJunio\Desktop\ProjetoAds\myApp\src\pages\candidates\candidates.page.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_auth_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__providers_rest_rest_service__["a" /* RestService */]])
    ], CandidatesPage);
